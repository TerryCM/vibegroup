...
// The whole registry, keyed by a short human label (e.g. "myteam", "backend").
...
// dir contains `cwd`, the most specific (longest bound dir) wins. This is what lets a
// project directory activate only its own room, including nested checkouts.
